    ...
    <div class="box">
        ...
        <form method="POST" action="">
            <div class="row">
                ...
                <div class="col-8">
                    <input name="edu" id="education" type="text" value="<?php echo $row1['EDUCATION'];?>">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-8">
                    <input name="insti" id="institute" type="text" value="<?php echo $row1['INSTITUTE_NAME'];?>">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-4">
                    <input style="background-color:#f2f2f2" name="da" id="sdate" type="date" value="<?php echo $row1['START_DATE'];?>">
                    <small style="color:black">Start date</small>
                </div>
                <div class="col-4">
                    <input  style="background-color:#f2f2f2" onchange="validateenddate(this)" id="edate" name="end" type="date" class="ml-4" value="<?php echo $row1['END_DATE'];?>">
            ...
            <div class="row">
                ...
                <div class="col-4">
                    <button type="submit" name="btnupded" class="btn btn-danger">Update</button>
                </div>
            </div>
        </form>
    </div>
