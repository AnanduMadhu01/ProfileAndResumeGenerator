...
<body>
  ...
  if($_SERVER['REQUEST_METHOD']=="POST"){
    ...
    $description=$_POST["dis"];
        if($project=="" || $year=="" || $description=="")
        {
            $error="Please enter all the field";
        }
        else{
            $qry="UPDATE `projectdetails` SET `PROJECT_NAME`='$project',`YEAR`='$year',`DESCRIPTION`='$description' WHERE `ID`='$id'";
            if(setData($qry)==true)
           {
            ?>
              <script>
    ...
    $sql1="SELECT * FROM `projectdetails` WHERE `ID`='$id'";
    ...
    <div class="box">
        ...
        <form method="POST">
            <div class="row">
                ...
                <div class="col-8">
                    <input name="project" type="text" value="<?php echo $row1['PROJECT_NAME'];?>" required           >
                </div>
            </div>
            <div class="row">
                <div class="col-3">
                ...
                <div class="col-4">
                    <input  style="background-color:#f2f2f2" name="year" type="month" value="<?php echo $row1['YEAR'];?>" required>
            ...
            <div class="row">
                ...
                <div class="col-8">
                    <textarea class="textarea" name="dis" required><?php echo $row1['DESCRIPTION'];?></textarea>
                    <small></small>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-4">
                    <a href="profile.php #resume" class="btn btn-danger">Cancel</a>
                </div>
                <div class="col-4">
