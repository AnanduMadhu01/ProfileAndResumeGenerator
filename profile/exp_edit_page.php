    ...
    <div class="box">
        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-4">
                    <input style="background-color:white" name="start" type="date" value="<?php echo $row1['START_DATE'];?>">
                    <small style="color:black">Start date</small>
                </div>
                <div class="col-4">
                    <input style="background-color:white" name="end" type="date" value="<?php echo $row1['END_DATE'];?>" class="ml-4">
