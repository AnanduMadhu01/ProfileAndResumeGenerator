...
<?php
    ...
    <div class="box">
        ...
        <div class="row">
                ...
                <div class="col-8">
                    <input type="text" pattern="[A-Za-z]" title="Only alphabet allowed" name="name" value="<?php if ($row5['NAME']==""){ echo $name; } else { echo $row5['NAME'];}?>">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-8">
                    <input type="tel" pattern="[0-9]{10}" name="phone" value="<?php echo $row5['PHONE'];?>">
